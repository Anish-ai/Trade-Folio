...
export default function Login() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-indigo-50 to-blue-100 p-4">
      <Card className="w-full max-w-md overflow-hidden rounded-lg shadow-xl">
        <div className="bg-gradient-to-r from-blue-500 to-indigo-600 py-8">
          ...
          <p className="mt-2 text-center text-blue-100">Log in to access your dashboard</p>
        </div>
        ...
        <CardContent className="p-8">
          <div className="space-y-6">
            ...
            <button 
              ...
              disabled={isLoading}
              className="flex w-full items-center justify-center gap-2 rounded-md border border-gray-300 bg-white py-3 px-4 text-gray-700 shadow-sm hover:bg-gray-50"
            >
              {isLoading ? (
